...
function AllUrls(){
    ...
    return <>
    <Nav /> 
    <section className="px-6 md:px-8 my-4 md:my-8  grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
        {urls && urls.map(url =>  <div className="flex">
            <div className="flex h-[72px] w-[72px] capitalize items-center justify-center font-semi text-3xl bg-primary rounded-lg border border-black mr-4">{url.title[0]}</div>
            <div className="">
